...
This document describes the data fetching setup for the epilot application.
...
- **AppSync build schema**: `amplify/backend/api/epilot/build/schema.graphql`
...
1. Edit your source schema at `amplify/backend/api/epilot/schema.graphql`
