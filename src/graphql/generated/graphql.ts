...
export type PriceSnapshotsByPkQuery = { __typename?: 'Query', priceSnapshotsByPk?: { __typename?: 'ModelPriceSnapshotConnection', items: Array<{ __typename?: 'PriceSnapshot', id: string, pk: string, capturedAt: string, priceUsd: number } | null> } | null };
...
export type OnCreatePriceSnapshotSubscription = { __typename?: 'Subscription', onCreatePriceSnapshot?: { __typename?: 'PriceSnapshot', id: string, pk: string, capturedAt: string, priceUsd: number } | null };
