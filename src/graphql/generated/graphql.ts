...
export type GetUserStateQuery = { __typename?: 'Query', getUserState?: { __typename?: 'UserState', id: string, score: number, streak: number, username: string, email: string } | null };
